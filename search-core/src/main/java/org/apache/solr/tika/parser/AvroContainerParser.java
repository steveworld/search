 ...
 * also be overriden.
 */
public class AvroContainerParser extends ReentrantParser {

  private static final MediaType MEDIA_TYPE = MediaType.parse("avro/binary");

  @Override
  protected StreamingAvroContainerParser createInstance() {
    StreamingAvroContainerParser parser = new StreamingAvroContainerParser();
