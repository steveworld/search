...
/**
 * Same as ParsingEmbeddedDocumentExtractor except that it throws exceptions up instead of swallowing them.
 */
final class StrictParsingEmbeddedDocumentExtractor implements EmbeddedDocumentExtractor {
    ...
    public StrictParsingEmbeddedDocumentExtractor(ParseContext context) {
