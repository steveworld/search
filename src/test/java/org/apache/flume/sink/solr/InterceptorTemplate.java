...
public class InterceptorTemplate implements Interceptor {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(InterceptorTemplate.class);

  private InterceptorTemplate(Context context) {
  }
  ...
  public static class Builder implements Interceptor.Builder {
    ...
    public Interceptor build() {
      return new InterceptorTemplate(context);
    }
