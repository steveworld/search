  ...
  public Integer parseArgs(String[] args, Configuration conf, CrunchIndexerToolOptions opts) {
    ...
    ArgumentParser parser = ArgumentParsers
        ...
        .description( 
            ...
            + "or a series of input data records (for splitable files), in the form of a Crunch PCollection. "
            + "\n\n"
            + "3) Morphline phase: This (parallel) phase takes the items of the PCollection generated by the previous "
    ...
    miscArgGroup.addArgument("--xhelp", "--help", "-help")
        ...
        .action(new HelpArgumentAction() {
          ...
          public void run(ArgumentParser parser, Argument arg, Map<String, Object> attrs, String flag, Object value) throws ArgumentParserException {
            ...
            System.out.println();
            System.out.print("MapReduceGenericOptions: " + ToolRunnerHelpFormatter.getGenericCommandUsage());
...
//              "This can be used for quicker turnaround during early trial & debug sessions.");
    ...
    Argument verboseArg = miscArgGroup.addArgument("--chatty", "--verbose")
        .action(Arguments.storeTrue())
